...
const defaultValues: Record<EpType, Endpoint> = {
  ...
  mieru: { type: EpTypes.Mieru, server: '', port: 0, port_range: '', transport: 'TCP', username: '', password: '', multiplexing: 'MULTIPLEXING_LOW', handshake_mode: 'HANDSHAKE_STANDARD', mtu: 1400 },
}
