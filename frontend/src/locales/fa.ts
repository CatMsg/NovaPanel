export default {
  ...
  noData: "بدون داده!",
  noChanges: "تغییری در پیکربندی وجود ندارد",
  ...
  main: {
    ...
    infos: "داده‌ها",
    hero: {
      badge: "مرکز کنترل NovaPanel",
      title: "همه‌چیز یک‌جا",
      subtitle: "وضعیت سیستم، Sing-Box و عملیات پرکاربرد را در یک جا ببینید.",
      live: "وضعیت زنده",
    },
    gauge: {
      cpu: "سنجش پردازنده",
  ...
  client: {
    ...
    history: "تاریخچه مرور",
    filters: "فیلترها",
    bulkActions: "عملیات گروهی",
    manageDesc: "کاربران، تغییرات گروهی، سابقه و وضعیت آنلاین را با عملیات یکسان در دسکتاپ و موبایل مدیریت کنید.",
    manageHint: "وضعیت، ترافیک، انقضا و عملیات کاربران را یکجا مشاهده کنید.",
    total: "مجموع",
    ...
    lastDay: "۲۴ ساعت گذشته",
    lastWeek: "۷ روز گذشته",
    lastMonth: "۳۰ روز گذشته",
    exportHistory: "خروجی",
    filtered: "فیلتر شده",
    basics: "پایه",
    config: "تنظیم",
  ...
  types: {
    ...
    wg: {
      ...
      peer: "همتا",
      peers: "همتاها",
      guideTitle: "ترتیب راه‌اندازی WireGuard",
      guide: "ابتدا کلیدها، آدرس تونل و درگاه UDP گره محلی را بررسی کنید، سپس کلاینت‌ها را اضافه کنید. پس از ذخیره می‌توان پروفایل کلاینت را دانلود یا اسکن کرد.",
      localSection: "گره محلی",
      localSectionHint: "هویت سرور WireGuard و تنظیمات شنود",
      privateHint: "برای ساخت جفت‌کلید جدید روی دکمه کلید بزنید",
      publicHint: "از کلید خصوصی ساخته می‌شود و کلاینت‌ها با آن این گره را شناسایی می‌کنند",
      localIpHint: "آدرس این گره در تونل، برای مثال 10.10.0.1/24",
      listenPortHint: "این درگاه UDP را در فایروال سیستم و گروه امنیتی ابری باز کنید",
      dnsHint: "در پروفایل خروجی کلاینت نوشته می‌شود، مانند 1.1.1.1, 9.9.9.9",
      systemHint: "معمولاً خاموش باشد؛ فقط برای رابط سیستم‌عامل روشن کنید",
      clientsSection: "کلاینت‌ها",
      clientsSectionHint: "هر کلاینت کلید و IP تونل مستقل دارد",
      addClient: "افزودن کلاینت",
      noClients: "هنوز کلاینتی اضافه نشده است. برای ساخت QR و پروفایل یک کلاینت اضافه کنید.",
      clientPrivateKey: "کلید خصوصی کلاینت",
      clientPrivateHint: "فقط در پروفایل کلاینت استفاده می‌شود؛ آن را امن نگه دارید",
      clientPublicKey: "کلید عمومی کلاینت",
      clientPublicHint: "این گره کلاینت را با کلید عمومی شناسایی می‌کند",
      optionalHint: "اختیاری؛ در صورت عدم استفاده خالی بگذارید",
      peerAddress: "آدرس عمومی کلاینت",
      peerAddressHint: "اگر کلاینت آدرس عمومی ثابت ندارد خالی بگذارید",
      peerPort: "درگاه عمومی کلاینت",
      peerPortHint: "اگر کلاینت درگاه عمومی ثابت ندارد خالی بگذارید",
      keepAliveHint: "برای کلاینت پشت NAT مقدار 25 ثانیه پیشنهاد می‌شود",
      clientTunnelIp: "IP تونل کلاینت",
      allowedIpHint: "آدرس اختصاص‌یافته به کلاینت، مانند 10.10.0.2/32",
    },
    lb: {
