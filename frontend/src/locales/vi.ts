export default {
  ...
  noChanges: "Không có thay đổi cấu hình",
  ...
  main: {
    ...
    infos: "Thông tin",
    hero: {
      badge: "Trung tâm điều khiển NovaPanel",
      title: "Nhìn tổng thể ngay",
      subtitle: "Xem trạng thái hệ thống, Sing-Box và các thao tác thường dùng ở cùng một chỗ.",
  ...
  setting: {
    ...
    loginBanAllowlistHint: "Administrative IPs / CIDRs that must never be banned.",
  ...
  client: {
    ...
    manageDesc: "Quản lý người dùng, thay đổi hàng loạt, lịch sử và trạng thái trực tuyến với thao tác nhất quán trên máy tính và điện thoại.",
    manageHint: "Xem trạng thái, lưu lượng, thời hạn và thao tác người dùng tại một nơi.",
    total: "Tổng",
    showing: "Đang hiển thị",
    offline: "Ngoại tuyến",
    exhausted: "Đã hết dung lượng",
  ...
  types: {
    ...
    wg: {
      ...
      peer: "Đối tác",
      peers: "Đối tác",
      guideTitle: "Thứ tự thiết lập WireGuard",
      guide: "Xác nhận khóa, địa chỉ đường hầm và cổng UDP của nút cục bộ trước, sau đó thêm máy khách. Có thể quét hoặc tải cấu hình máy khách sau khi lưu.",
      localSection: "Nút cục bộ",
      localSectionHint: "Danh tính máy chủ WireGuard và thiết lập lắng nghe",
      privateHint: "Nhấn nút khóa để tạo cặp khóa mới",
      publicHint: "Được tạo từ khóa riêng và dùng để máy khách nhận diện nút này",
      localIpHint: "Địa chỉ của nút trong đường hầm, ví dụ 10.10.0.1/24",
      listenPortHint: "Cho phép cổng UDP này trong tường lửa hệ thống và nhóm bảo mật đám mây",
      dnsHint: "Được ghi vào cấu hình máy khách, ví dụ 1.1.1.1, 9.9.9.9",
      systemHint: "Thường để tắt; chỉ bật khi cần giao diện hệ điều hành",
      clientsSection: "Máy khách",
      clientsSectionHint: "Mỗi máy khách dùng khóa và IP đường hầm riêng",
      addClient: "Thêm máy khách",
      noClients: "Chưa có máy khách. Hãy thêm để tạo mã QR và cấu hình máy khách.",
      clientPrivateKey: "Khóa riêng máy khách",
      clientPrivateHint: "Chỉ dùng trong cấu hình máy khách xuất ra; hãy bảo mật",
      clientPublicKey: "Khóa công khai máy khách",
      clientPublicHint: "Nút này dùng khóa công khai để nhận diện máy khách",
      optionalHint: "Tùy chọn; để trống nếu không dùng",
      peerAddress: "Địa chỉ công khai máy khách",
      peerAddressHint: "Để trống nếu máy khách không có địa chỉ công khai cố định",
      peerPort: "Cổng công khai máy khách",
      peerPortHint: "Để trống nếu máy khách không có cổng công khai cố định",
      keepAliveHint: "Khuyến nghị 25 giây khi máy khách ở sau NAT",
      clientTunnelIp: "IP đường hầm máy khách",
      allowedIpHint: "Địa chỉ cấp cho máy khách, ví dụ 10.10.0.2/32",
    },
    lb: {
