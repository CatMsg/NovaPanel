export default {
  ...
  noData: "Нет данных!",
  noChanges: "Нет изменений конфигурации",
  ...
  main: {
    ...
    infos: "Информация",
    hero: {
      badge: "Панель управления NovaPanel",
      title: "Всё видно сразу",
      subtitle: "Состояние системы, Sing-Box и основные действия собраны в одном месте.",
      live: "Текущий статус",
    },
    gauge: {
      cpu: "Загрузка ЦП",
  ...
  client: {
    ...
    manageDesc: "Управляйте пользователями, массовыми изменениями, историей и статусом онлайн с едиными действиями на ПК и телефоне.",
    manageHint: "Статус, трафик, срок действия и действия пользователей в одном месте.",
    total: "Всего",
    showing: "Показано",
    offline: "Не в сети",
  ...
  types: {
    ...
    wg: {
      ...
      peer: "Пир",
      peers: "Пиры",
      guideTitle: "Порядок настройки WireGuard",
      guide: "Сначала проверьте ключи локального узла, адрес туннеля и UDP-порт, затем добавьте клиентов. После сохранения профиль можно скачать или открыть как QR-код.",
      localSection: "Локальный узел",
      localSectionHint: "Идентификация сервера WireGuard и параметры прослушивания",
      privateHint: "Нажмите кнопку ключа, чтобы создать новую пару ключей",
      publicHint: "Вычисляется из закрытого ключа и используется клиентами для идентификации узла",
      localIpHint: "Адрес узла внутри туннеля, например 10.10.0.1/24",
      listenPortHint: "Разрешите этот UDP-порт в системном и облачном брандмауэре",
      dnsHint: "Добавляется в экспортируемый профиль клиента, например 1.1.1.1, 9.9.9.9",
      systemHint: "Обычно выключено; включайте только для системного интерфейса",
      clientsSection: "Клиенты",
      clientsSectionHint: "Каждый клиент использует отдельный ключ и IP туннеля",
      addClient: "Добавить клиента",
      noClients: "Клиентов пока нет. Добавьте клиента для создания QR-кода и профиля.",
      clientPrivateKey: "Закрытый ключ клиента",
      clientPrivateHint: "Используется только в профиле клиента; храните его безопасно",
      clientPublicKey: "Открытый ключ клиента",
      clientPublicHint: "Этот узел идентифицирует клиента по открытому ключу",
      optionalHint: "Необязательно; оставьте пустым, если не используется",
      peerAddress: "Публичный адрес клиента",
      peerAddressHint: "Оставьте пустым, если у клиента нет постоянного публичного адреса",
      peerPort: "Публичный порт клиента",
      peerPortHint: "Оставьте пустым, если у клиента нет постоянного публичного порта",
      keepAliveHint: "Для клиента за NAT рекомендуется 25 секунд",
      clientTunnelIp: "IP клиента в туннеле",
      allowedIpHint: "Адрес, назначенный клиенту, например 10.10.0.2/32",
    },
    lb: {
