export default {
  ...
  main: {
    ...
    infos: "Information",
    hero: {
      badge: "NovaPanel control center",
      title: "Get the full picture",
      subtitle: "See system status, Sing-Box health, and everyday actions in one place.",
      live: "Live status",
    },
    gauge: {
      cpu: "CPU Gauge",
  ...
  setting: {
    ...
    loginBanAllowlist: "Login ban allowlist",
    loginBanAllowlistHint: "Administrative source IPs / CIDRs that must never be permanently banned.",
    ...
    subModeMaster: "Master Mode",
    subModeSlave: "Slave Mode",
    subMasterSources: "Master Upstream URLs",
    subMasterSourcesHint: "Enter one upstream subscription URL per line. The system will merge only these upstream nodes.",
    subAggregateUri: "Aggregate Subscription URI",
  ...
  client: {
    ...
    manageDesc: "Manage users, bulk changes, history, and online status with consistent desktop and mobile actions.",
    manageHint: "Review user status, traffic, expiry, and common actions in one place.",
    total: "Total",
    showing: "Showing",
    offline: "Offline",
  ...
  types: {
    ...
    wg: {
      ...
      peer: "Peer",
      peers: "Peers",
      guideTitle: "WireGuard setup order",
      guide: "Confirm the local keys, tunnel address, and UDP listen port first, then add clients. Client profiles can be scanned or downloaded after saving.",
      localSection: "Local node",
      localSectionHint: "WireGuard server identity and listen settings",
      privateHint: "Use the key button to generate a new key pair",
      publicHint: "Derived from the private key and used by clients to identify this node",
      localIpHint: "Tunnel address of this node, for example 10.10.0.1/24",
      listenPortHint: "Allow this UDP port in the system firewall and cloud security group",
      dnsHint: "Written to exported client profiles, for example 1.1.1.1, 9.9.9.9",
      systemHint: "Usually disabled; enable only when an OS interface is required",
      clientsSection: "Clients",
      clientsSectionHint: "Each client uses an independent key and tunnel IP",
      addClient: "Add client",
      noClients: "No clients yet. Add one to generate a QR code and client profile.",
      clientPrivateKey: "Client private key",
      clientPrivateHint: "Used only in the exported client profile; keep it secure",
      clientPublicKey: "Client public key",
      clientPublicHint: "This node uses the public key to identify the client",
      optionalHint: "Optional; leave empty when unused",
      peerAddress: "Client public address",
      peerAddressHint: "Leave empty when the client has no fixed public address",
      peerPort: "Client public port",
      peerPortHint: "Leave empty when the client has no fixed public port",
      keepAliveHint: "25 seconds is recommended when the client is behind NAT",
      clientTunnelIp: "Client tunnel IP",
      allowedIpHint: "Address assigned to this client, for example 10.10.0.2/32",
    },
    lb: {
