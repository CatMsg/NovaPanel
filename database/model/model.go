...
type Client struct {
	...
	UploadLimit   int64           `json:"uploadLimit" form:"uploadLimit" gorm:"default:0;not null"`
	DownloadLimit int64           `json:"downloadLimit" form:"downloadLimit" gorm:"default:0;not null"`
