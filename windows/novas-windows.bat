...
REM NovaPanel Windows Control Script
REM This script provides a menu-driven interface for managing NovaPanel on Windows

cd /d "%~dp0"
set "SERVICE_NAME=novas"
set "INSTALL_DIR=%NOVAS_HOME%"
if "%INSTALL_DIR%"=="" set "INSTALL_DIR=C:\Program Files\novas"

:menu
cls
echo ========================================
echo NovaPanel Windows Control Panel
echo ========================================
echo.
echo Current directory: %INSTALL_DIR%
echo.
echo 1. Start NovaPanel Service
echo 2. Stop NovaPanel Service
echo 3. Restart NovaPanel Service
echo 4. Check Service Status
echo 5. View Service Logs
echo 6. Open Panel in Browser
echo 7. Run NovaPanel Manually
...
:check_status
echo Checking NovaPanel service status...
...
:open_panel
echo Opening NovaPanel panel in browser...
...
:run_manual
echo Running NovaPanel manually...
if exist "%INSTALL_DIR%\novas.exe" (
    cd /d "%INSTALL_DIR%"
    echo Starting NovaPanel in current window...
    echo Press Ctrl+C to stop
    echo.
    novas.exe
) else (
    echo NovaPanel executable not found: %INSTALL_DIR%\novas.exe
...
cls
echo ========================================
echo Service Management (compatibility alias)
echo ========================================
echo.
...
echo.
echo ========================================
echo NovaPanel Configuration (compatibility commands)
echo ========================================
if exist "%INSTALL_DIR%\novas.exe" (
    cd /d "%INSTALL_DIR%"
    echo Current settings:
    novas.exe setting -show
    echo.
    echo Admin credentials:
    novas.exe admin -show
) else (
    echo NovaPanel executable not found. Please run the installer first.
)
pause
goto menu
...
:exit
echo Thank you for using NovaPanel Windows Control Panel!
exit /b 0
